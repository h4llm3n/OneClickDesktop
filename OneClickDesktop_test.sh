...
GUACAMOLE_DOWNLOAD_LINK="https://mirrors.ocf.berkeley.edu/apache/guacamole/1.3.0/source/guacamole-server-1.3.0.tar.gz"
...
function install_guacamole_ubuntu_debian
{
	...
	if [ "$OS" = "DEBIAN10" ] ; then
		...
		apt-get -t buster-backports install freerdp2-dev libpulse-dev
	else
